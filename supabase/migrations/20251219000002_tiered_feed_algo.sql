-- Tiered Feed Algorithm
-- Implements a time-bucketed scoring strategy to prioritize recent content
-- while still using engagement metrics for sorting within those time windows.
